...
const CourseDetails = ({course}) => {
    ...
    <div className="p-6">
        <div>
            ...
            <h2  className="block mt-5 text-2xl font-bold text-gray-800 transition-colors duration-300 transform">What you'll learn</h2>
            {
                description.benefits.map((benefit,i)=> <div className="flex  items-start mt-4 text-gray-700 dark:text-gray-200" key={i}>
            ...
            <h2  className="block mt-5 text-2xl font-bold text-gray-800 transition-colors duration-300 transform" >Description</h2>
