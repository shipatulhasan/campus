        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="bg-white border border-slate-400 shadow-xl rounded md:w-1/2 w-full p-10 mt-6">
                ...
                <button aria-label="Sign Up with google"
                  ...
                  className="w-5/12 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 hover:bg-blue-700 hover:border-blue-700 hover:text-slate-100 flex items-center  mt-4">
                ...
                <button aria-label="Sign Up with github"  className="w-5/12 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 hover:bg-blue-700 hover:border-blue-700 hover:text-slate-100 flex items-center  mt-4">
