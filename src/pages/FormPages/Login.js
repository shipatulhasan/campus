            ...
            <div className="flex flex-col items-center justify-center">
               <Link to='/'><img className='w-1/2 mx-auto' src={logo} alt="" /></Link>
                <div className="bg-white border border-slate-400 shadow-xl rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-6">
                    ...
                    <button onClick={handleSignInWithGoogle} aria-label="Continue with google"  className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-blue-700 hover:border-blue-700 hover:text-slate-100 text-base font-medium">
                    ...
                    <button aria-label="Continue with github"  className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-blue-700 hover:border-blue-700 hover:text-slate-100 text-base font-medium">
                    ...
                    <div className="mt-6">
                        <button aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-slate-100 text-base font-semibold leading-none text-white focus:outline-none bg-blue-700 border rounded hover:bg-blue-900 py-4 w-full">
                            Login
                        </button>
                    </div>
                    </form>
                    
                        <Link to='/reset-password' tabIndex={0} role="link" className=" text-base font-medium leading-none underline text-blue-700 cursor-pointer">
                            <p className='mt-4'>
                            Forget Password
                            </p>
